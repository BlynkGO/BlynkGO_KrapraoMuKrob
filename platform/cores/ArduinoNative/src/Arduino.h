...
#ifndef ArduinoNative_h
#define ArduinoNative_h
...
inline void println(const char* message="")             { printf("%s\n", message);              }
inline void println(String message)                     { printf("%s\n", message.c_str());      }
inline void println(int n)                              { printf("%d\n", n);                    }
inline void println(float f, uint32_t decimal=2)        { printf("%.*f\n", decimal, f);         }
inline void println(double f, uint32_t decimal=2)       { printf("%.*f\n", decimal, f);         }

inline void print(const char* message="")               { printf("%s", message);                }
inline void print(String message)                       { printf("%s", message.c_str());        }
inline void print(int n)                                { printf("%d", n);                      }
