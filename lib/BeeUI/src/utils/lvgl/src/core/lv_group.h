...
typedef enum {
    ...
    LV_KEY_CTRL_C       = 21,  /* BlynkGO */
    LV_KEY_CTRL_V       = 22,  /* BlynkGO */
    LV_KEY_CTRL_X       = 23,  /* BlynkGO */
    LV_KEY_SHIFT_UP     = 117,  /* BlynkGO */
    LV_KEY_SHIFT_DOWN   = 118,  /* BlynkGO */
    LV_KEY_SHIFT_LEFT   = 119,  /* BlynkGO */
    LV_KEY_SHIFT_RIGHT  = 120,  /* BlynkGO */
} lv_key_t;
